...
export const metadata: Metadata = {
  ...
  description:
    "Talk to Bukwin AI to book, reschedule, or cancel appointments. Available 24/7.",
};
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-10">
        <Link
          href="/"
          className="flex items-center gap-2 text-sm text-gray-600 hover:text-[#4F46E5] transition-colors"
        >
