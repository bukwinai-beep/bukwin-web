...
const DOMAIN_KEY = process.env.NEXT_PUBLIC_CHATKIT_DOMAIN_KEY || "domain_pk_6a82dfc9ada88196b1a3bce3bd5580920719d50b122eba10";
const API_URL = process.env.NEXT_PUBLIC_CHATKIT_API_URL || "https://openai.secondbrainos.com/chatkit";
